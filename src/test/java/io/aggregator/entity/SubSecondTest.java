...
public class SubSecondTest {
  ...
  public void addTransactionTest() {
    ...
    assertEquals("1.23", subSecondLedgerItemsAdded.getLedgerEntries(0).getAmount());
    ...
    assertEquals("1.23", ledgerEntry.getAmount());
    ...
    assertEquals("account-from-1", ledgerEntry.getTransactionKey().getAccountFrom());
    assertEquals("account-to-1", ledgerEntry.getTransactionKey().getAccountTo());
    assertEquals("4.56", ledgerEntry.getAmount());
    assertTrue(ledgerEntry.getTimestamp().getSeconds() > 0);
  }
  ...
  public void aggregateSubSecondTest() {
    ...
    assertEquals("13.68", subSecondAggregated.getMoneyMovements(0).getAmount());
    ...
    assertEquals(epochSubSecond, subSecondAggregated.getEpochSubSecond());
    assertEquals(1, subSecondAggregated.getMoneyMovementsCount());
    assertEquals("9.75", subSecondAggregated.getMoneyMovements(0).getAmount());
  ...
  static SubSecondApi.AddLedgerItemsCommand addLedgerItemsCommand(long epochSubSecond, String transactionId, String amount) {
    return addLedgerItemsCommand(epochSubSecond, transactionId, amount, TimeTo.now());
  }

  static SubSecondApi.AddLedgerItemsCommand addLedgerItemsCommand(long epochSubSecond, String transactionId, String amount, Timestamp timestamp) {
