...
public class TransactionIntegrationTest {
  ...
  public void addPaymentOnNonExistingEntity() throws Exception {
    // TODO: set fields in command, and provide assertions to match replies
    // client.addPayment(TransactionApi.AddPaymentCommand.newBuilder().build())
    //         .toCompletableFuture().get(5, SECONDS);
  }

  @Test
  public void getTransactionOnNonExistingEntity() throws Exception {
    // TODO: set fields in command, and provide assertions to match replies
    // client.getTransaction(TransactionApi.GetTransactionRequest.newBuilder().build())
    //         .toCompletableFuture().get(5, SECONDS);
  }
}
